...
contract Codechain is Ownable {
    string private constant _name = unicode"Codechain";
    ...
    address private revWallet = 0x01C1E9b63B7A86a0b8CA9fd49F549fC3BdBF5b0C;
    address private treasuryWallet = 0x01C1E9b63B7A86a0b8CA9fd49F549fC3BdBF5b0C;
    address private teamWallet = 0x01C1E9b63B7A86a0b8CA9fd49F549fC3BdBF5b0C;
    ...
    constructor() {
        ...
        address airdropWallet = 0x01C1E9b63B7A86a0b8CA9fd49F549fC3BdBF5b0C;
        ...
        setExcludedFromMaxTransaction(
            0xF7ea783C7dba3Ca70cb82630fF9d4214769cbCe8,
            true
        );
        setExcludedFromMaxTransaction(
            0x9635Cbf94bc8054C0a3a6f21AC67FEDe917cc268,
            true
        );
        setExcludedFromMaxTransaction(
            0x1879FADDA52C8eC68Cf58c96ACf71e430AAa36ff,
            true
        );
        setExcludedFromMaxTransaction(
            0x1AB91F2092379435490932Eb12Db56f354D79092,
            true
        );
        setExcludedFromMaxTransaction(
            0xFC2Be2C4c4100cb5A6Af09699063dc401046F95A,
            true
        );
        setExcludedFromMaxTransaction(
            0x67532D44471d113Be272361fe03C48060034AE45,
            true
        );
        setExcludedFromMaxTransaction(
            0x20b0FC7B607D50c2c820758C2EB67DBB25BBfa16,
            true
        );
        setExcludedFromMaxTransaction(
            0xf063e64Fa1edE8311E0C7A7e74B45Cf955824320,
            true
        );
        setExcludedFromMaxTransaction(
            0xddDF50147Da89Cf72E432b037B70d0918692c52f,
            true
        );
    ...
    function unleashTheCode() external payable onlyOwner {
        require(!launched, "Already launched");
